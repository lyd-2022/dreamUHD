...
from basicsr.archs.encoder_3 import nonlinearity, Normalize, ResnetBlock, make_attn, Downsample, Upsample,fresadd
...
if __name__== '__main__': 
    ...
    model = SAFMN_adenc(dim=48, n_blocks=8, ffn_scale=2.0, upscaling_factor=16,
                         vae_weight='/data/liuyidi/nitre_2023_dehaze/data_dehaze/uhdformer/experiments/KL16_32_freupa2/models/net_g_latest.pth',
                         config='/code/UHDformer-main/options/VAE/kl_16_freup.yml').to('cuda')
