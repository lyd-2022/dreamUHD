    ...
    def __init__(self, dim, n_blocks=8, ffn_scale=2.0, upscaling_factor=4,vae_weight=None,config=None,sample= True):
        ...
        with open(config) as f:
            ...
            if vae_weight:
                ...
                msg = self.vae.load_state_dict(torch.load(vae_weight,map_location='cpu')["params"],strict=True)
...
if __name__== '__main__': 
    ...
    model = SAFMN_froenc2(dim=48, n_blocks=8, ffn_scale=2.0, upscaling_factor=16,
                         vae_weight='/data/liuyidi/nitre_2023_dehaze/data_dehaze/uhdformer/experiments/KL_16_32/models/net_g_latest.pth',
                         config='/code/UHDformer-main/options/VAE/kl_16.yml').to('cuda')
