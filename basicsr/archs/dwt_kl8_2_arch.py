...
class dwt_kl8_2(nn.Module):
    def __init__(self, dim, n_blocks=8, ffn_scale=2.0, upscaling_factor=4,vae_weight=None,config=None,sample= True,dwt_dim = 16,num_heads=3):
        super().__init__()
...
if __name__== '__main__': 
    ...
    model = dwt_kl8(dim=48, n_blocks=8, ffn_scale=2.0, upscaling_factor=8,dwt_dim=3,num_heads=3,
