...
class WTblock(nn.Module):
    def __init__(self, in_channels, out_channels,enc_channel, kernel_size=5, stride=1, bias=True, wt_levels=1, wt_type='db1'):
        ...
        self.enc_scale = _ScaleModule([1,enc_channel,1,1], init_scale=0.1)
...
if __name__== '__main__': 
    ...
    model = dwt_kl8_7(dim=48, n_blocks=8, ffn_scale=2.0, upscaling_factor=8,dwt_dim=3,num_heads=3,
