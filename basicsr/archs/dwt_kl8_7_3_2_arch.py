...
if __name__== '__main__': 
    ...
    with open("/mnt/petrelfs/liuyidi/Code/dreamUHD/experiments/61k-lr8/61k-lr8.yml") as f:
        config = yaml.load(f, Loader=yaml.FullLoader)["network_g"]
    config.pop('type')
    #添加一个参数ckpt_path
    # config["ckpt_path"] = "/mnt/petrelfs/liuyidi/Code/dreamUHD/experiments/LL/VAE/VAE_LL.pth"

    model = dwt_kl8_7_3_2(**config)
    # model1 = model.LatentIR
    # model2 = model.vae
    # model3 = model.rev_layers
