...
from basicsr.archs.Resblock.Res_four import Res_four,Res_four2,Res_four3,Res_four4,Res_four5,Res_four6,Res_four7,Res_four8,Res_four9
from basicsr.archs.restormer import Restormer
...
def make_res(in_channels, out_channels,temb_channels,dropout, res_type="vanilla"):
    assert res_type in ["vanilla", "Fourmer","MAB","Res_four","Res_four2","Res_four3","Res_four4","Res_four5","Res_four6","Res_four7","Res_four8","Res_four9","none"], f'res_type {res_type} unknown'
...
class dwt_kl8_7_3_2_naf(nn.Module):
    def __init__(self, dim, width=16, middle_blk_num=1, enc_blk_nums=[2, 3, 3, 4], dec_blk_nums=[2, 3, 3, 4],vae_weight=None,config=None,sample= True,dwt_dim = 16,num_heads=3,param_key = 'params'):
        super().__init__()
        ...
        self.feats = NAFNet(img_channel=dim, width=width, middle_blk_num=middle_blk_num, enc_blk_nums=enc_blk_nums, dec_blk_nums=dec_blk_nums)
...
if __name__== '__main__': 
    ...
    model = dwt_kl8_7_3_2_naf(dim=16,dwt_dim=3,num_heads=3,
                         vae_weight='/data/liuyidi/nitre_2023_dehaze/data_dehaze/uhdformer/experiments/120kema_resfour6_1/models/net_g_latest.pth',
                         config='/data/liuyidi/nitre_2023_dehaze/data_dehaze/uhdformer/experiments/120kema_resfour6_1/8_16_res.yml').to('cuda')
