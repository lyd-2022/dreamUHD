...
class dwt_kl8_7_3_2_restormer(nn.Module):
    def __init__(self, dim, num_blocks=[2, 3, 3, 4], heads=[1, 2, 4, 8],vae_weight=None,config=None,sample= True,dwt_dim = 16,num_heads=3,param_key = 'params'):
        super().__init__()
        ...
        self.feats = Restormer(dim= dim,out_channels=dim,num_blocks=num_blocks, heads=heads)
...
if __name__== '__main__': 
    ...
    model = dwt_kl8_7_3_2_restormer(dim=16,dwt_dim=3,num_heads=3,
