...
class dwt_kl8_7_3_2m(nn.Module):
    def __init__(self, dim, n_blocks=8, ffn_scale=2.0, upscaling_factor=4,vae_weight=None,config=None,sample= True,dwt_dim = 16,num_heads=3,param_key = 'params',out_dim= 64):
        ...
        self.feats = nn.Sequential(*[AttBlock(out_dim-dim, ffn_scale) for _ in range(n_blocks)])
...
if __name__== '__main__': 
    ...
    model = dwt_kl8_7_3_2m(dim=24, n_blocks=8, ffn_scale=2.0, upscaling_factor=8,dwt_dim=3,num_heads=3,out_dim=40,
