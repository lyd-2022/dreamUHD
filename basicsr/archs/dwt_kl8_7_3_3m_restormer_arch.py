...
class dwt_kl8_7_3_3m_restormer(nn.Module):
    def __init__(self, dim,upscaling_factor=8, num_blocks=[1, 2, 2, 1], heads=[1, 2, 4, 8],vae_weight=None,config=None,sample= True,dwt_dim = 16,num_heads=3,param_key = 'params',mid_dim =24):
        super().__init__()
        out_dim = dim+16
        ...
        self.feats = Restormer(dim= mid_dim,out_channels=mid_dim,num_blocks=num_blocks, heads=heads)
...
if __name__== '__main__': 
    ...
    model = dwt_kl8_7_3_3m_restormer(dim=24, upscaling_factor=8,dwt_dim=3,num_heads=3,mid_dim=36,
