...
class AutoencoderKL(nn.Module):
    def __init__(self,
        ...
        self.adapter_mid = nn.Sequential(make_attn(dwt_dim*4+64, attn_type="restormer",num_heads=4),
                                         nn.Conv2d(dwt_dim*4+64, dwt_dim, 1),
...
class dwt_adapter (nn.Module):
    def __init__(self, in_channels, out_channels,enc_channel, kernel_size=5, stride=1,last = False):
        ...
        self.zeroconv = ZeroConv2d(in_channels*4+enc_channel, enc_channel, 3,padding=1, stride=stride)
        if not self.last:
        ...
        for i_level in range(self.num_resolutions):
            ...
            if i_level != self.num_resolutions - 1:
                ...
                if i_level != self.num_resolutions - 2:
                    ...
                    self.adapters.append(dwt_adapter(dwt_dim,dwt_dim,block_out,last=True))
...
if __name__== '__main__': 
    ...
    model = dwt_kl8_7_5(dim=48, n_blocks=8, ffn_scale=2.0, upscaling_factor=8,dwt_dim=3,num_heads=3,
