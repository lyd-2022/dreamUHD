...
sys.path.append('/code/UHDformer-main/basicsr')

from basicsr.archs.fema_utils import ResBlock, CombineQuantBlock
...
if __name__ == '__main__':
  ...
  ffn_matching: True
  ffn_restormer: False'''
    model = FeMaSRNet_701(number_block=5,num_heads=8,match_factor=4,ffn_expansion_factor=4,scale_factor=8,bias=True,LayerNorm_type='WithBias',attention_matching=True,ffn_matching=True,ffn_restormer=False)
    print(model)
    model = model.cuda()
